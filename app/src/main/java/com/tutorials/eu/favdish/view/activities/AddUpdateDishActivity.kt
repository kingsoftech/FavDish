...
import com.tutorials.eu.favdish.model.database.FavDishRoomDatabase_Impl
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mFavDishDetails?.let {
            if(it.id != 0){
                ...
                mBinding.etCategory.setText(it.cookingTime)
                ...
                when {
                    ...
                    TextUtils.isEmpty(cookingDirection) -> {
                        ...
                        if(dishID == 0){
                            ...
                            Toast.makeText(
                                this@AddUpdateDishActivity,
                                "You successfully edited your favorite dish details.",
                                Toast.LENGTH_SHORT
                            ).show()
                        }
                        finish()
